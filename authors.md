...
- **Anna-Lena Schubert**. Author, thesis advisor.
  [](https://orcid.org/0000-0001-7248-0662)

## Citation

Source:
[`DESCRIPTION`](https://github.com/MeikeSteinhilber/sprtt/blob/0.3.1/DESCRIPTION)

Snijder-Steinhilber M, Schnuerch M, Schubert A (2026). *sprtt:
Sequential Probability Ratio Tests Toolbox*. R package version 0.3.1,
