...
# test_that("check_data_ttest: formula: Correct activation of errors", {
#   input1 <- x~y
#
#   x <- rnorm(1)
#   y <- as.factor(2)
#   expect_error(
#     check_data_ttest(input1, x, y, paired = FALSE),
#     "at least 3 observations"
#   )
#   x <- rnorm(3)
#   y <- c(2,5,2)
...
#   expect_error(
#     check_data_ttest(input1, x, y, paired = TRUE),
