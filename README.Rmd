...
The sample size planning functions require simulation data (~15 MB). On first use, this data will be downloaded automatically:
```r
library(sprtt)
...
If you need to use the package offline, download the data while connected:
```r
