...
| $N_{\text{median}}$ | The median sample size at which a decision is reached across simulations. In a single study, the required sample size is expected to be close to this value.|
...
Each violin summarizes how often a given $n$ occurred.
