...
Using $N_{\text{max}} = `r n_max`$ will decrease the power to $\text{Power}_{N_{\text{max}}}=$ `r power_nmax`%, which includes missing the effect due to Type II errors and non-decisions.
:::
