...
h3 {
  ...
  margin-bottom: 0.8em !important; /* Space below */
}
...
/* Increase TOC width and move it to the left edge */
.tocify {
  width: 19% !important;
  max-width: 400px !important;
  left: 250px !important;  /* Pin to left edge */
  top: 90px; /* leave extra space for .toc-text-top */
}

/* Adjust main content to not overlap with TOC */
.col-md-9 {
  width: 85% !important;
  margin-left: 25% !important;  /* More margin to create space */
}
...
<!-- ::: {.alert .alert-info} -->
<!--  &#128712; The actual sample size in any individual study may be considerably smaller or larger than the simulated averages presented here. -->
<!-- ::: -->
...
## II. Sample size recommendations
...
## III. Extended Results: Various true effects
