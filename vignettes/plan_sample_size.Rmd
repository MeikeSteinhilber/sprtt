...
To minimize Type II errors, you set $\beta = 0.00$, limiting false acceptances of $H_0$ to 5%.
...
Critically, when a decision is reached—whether rejecting $H_0$ (favoring $H_1$) or accepting $H_0$—you can trust it: Type I and II errors are controlled at 5% in the long run.
