...
**The challenge:** While this data-driven stopping rule is statistically elegant and very efficient, it creates practical difficulties.
...
SPRTs like the sequential ANOVA differentiate between stopping data collection to accept the null hypothesis and the case where more data/evidence is required to stop.
