...
Critically, whether that conclusion is to reject $H_0$ (favoring $H_1$) or accept $H_0$, you can trust the decision: you've limited false acceptances of $H_1$ to 5% and false acceptances of $H_0$ to 10% in the long run.
