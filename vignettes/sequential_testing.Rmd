...
After the calculation of the test statistic, the decision will be either to continue sampling or to terminate and accept one of the hypotheses. @wald1945a defined the following rules for the SPRT:
