...
If you want to perform a two-sample test, you need to use the `y` argument in addition to `x`. If the data are stored in a data frame, you need the `$` operator or the `data` argument, to get access to the variables.
...
If you want to perform a one-sample test you have only one group and therefore only one variable. If the data are in a data frame, you need the `$` operator or the `data` argument, to get access to the variables. You need also the `mu` argument, which specifies the mean which you want to test against.
...
# sequential t-tes: data argument ----------------------------------------------
seq_ttest(treatment_group,     # x argument
          mu = 3.5, 
          data = df,
          d = 0.2,                  
          verbose = FALSE)
...
# sequential t-tes: $ operator -------------------------------------------------
seq_ttest(baseline_stress, # x argument
