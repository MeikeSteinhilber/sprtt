...
To use the `sprtt` package one has to install and load it first. You can install the package directly in RStudio from CRAN, where you get the latest release version or you can install the package in the latest development version on GitHub. You can find more information for the installation on the [start site](https://meikesteinhilber.github.io/sprtt/).
